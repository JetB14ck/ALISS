...
namespace ALISS.DropDownList.Api.Controllers
{
    ...
    public class AreaHealthListController : Controller
    {
        ...
        [HttpPost]
        [Route("api/DropDownList/GetAreaHealthContactList/")]
        public List<TCAreaHealthContact> GetAreaHealthContactList([FromBody] TCAreaHealthContact searchModel)
        {
            var objReturn = _service.Get_AreaHealthContact_List(searchModel);

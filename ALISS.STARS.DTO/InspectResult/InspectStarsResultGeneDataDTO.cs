...
{
    public class InspectStarsResultGeneDataDTO
    {
        public int srg_id { get; set; }
        public string srg_starsno { get; set; }
        public int? srg_mg_id { get; set; }
        ...
        public string srg_vand_gene { get; set; }
        ...
        public string srg_ctxm_gene { get; set; }
        public string srg_tem_gene { get; set; }
        public string srg_shv_gene { get; set; }
        public string srg_serotype_gene { get; set; }
        public string srg_serogroup_gene { get; set; }
        public string srg_mcim_gene { get; set; }
        public string srg_status { get; set; }
        public string srg_createduser { get; set; }
        public DateTime? srg_createddate { get; set; }
        public string srg_updateuser { get; set; }
        public DateTime? srg_updatedate { get; set; }
    }
}

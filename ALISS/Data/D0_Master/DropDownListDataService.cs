...
namespace ALISS.Data.D0_Master
{
    public class DropDownListDataService
    {
        ...
        public async Task<List<DropDownListDTO>> GetMachineTypeListByModelAsync(DropDownListDTO searchModel)
        {
            List<DropDownListDTO> objList = new List<DropDownListDTO>();

            objList = await _apiHelper.GetDataListByModelAsync<DropDownListDTO, DropDownListDTO>("dropdownlist_api/GetMachineTypeList", searchModel);
        ...
        public async Task<List<TCAreaHealthContact>> GetAreaHealthListContactByModelAsync(TCAreaHealthContact searchModel)
        {
            List<TCAreaHealthContact> objList = new List<TCAreaHealthContact>();

            objList = await _apiHelper.GetDataListByModelAsync<TCAreaHealthContact, TCAreaHealthContact>("dropdownlist_api/GetAreaHealthContactList", searchModel);
